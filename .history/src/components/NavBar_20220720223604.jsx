...
const NavBar = () => {
  cost [isOpen, setIsOpen] = useState(false);
  const toggle = () => {
    setIsOpen(!isOpen);
  }
  return (
    <div className='flex justify-between items-center h-20 max-w-[1240px] mx-auto px-4 text-white'>
        ...
        <div>
          {!isOpen ?<IoCloseSharp className='cursor-pointer' size={20} onClick={toggle}/> : <GiHamburgerMenu className='cursor-pointer' size={20} onClick={toggle}/>}
        </div>

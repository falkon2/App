...
export const PageOne = () => {
  return (
    <div
          ...
          A website builder that is focused on <a className="underline text-gray-400">design</a> and 
            <a className="underline text-gray-400"> simplicity</a>
          </p>
          <button

  ...
  return (
    <div className='flex justify-between items-center h-20 max-w-[1240px] mx-auto px-4 text-white'>
        ...
        <ul className='hidden  md:flex'>
            <li className='p-4 mx-5 cursor-pointer hover:ease-in-out hover:duration-700 hover:underline'><a href="/">Home</a></li>
            <li className='p-4 mx-5 cursor-pointer hover:ease-in-out hover:duration-700 hover:underline'>About</li>
            <li className='p-4 mx-5 cursor-pointer hover:ease-in-out hover:duration-700 hover:underline'>Host</li>
            <li className='p-4 mx-5 cursor-pointer hover:ease-in-out hover:duration-700 hover:underline'>Tutorial</li>
        </ul>

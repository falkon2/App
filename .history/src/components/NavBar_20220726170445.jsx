...
const NavBar = () => {
  ...
  return (
    <div className='flex sticky z-10 justify-between items-center h-20 max-w-full mx-auto px-4 text-white  top-0'>
        ...
        <NavLink to="/details" activeClassName="active" ><li className='p-4 border-b border-gray-700 hover:border-white hover:transition-[0.5s] hover:ease-in-out'>About</li></NavLink>
        <NavLink to="https://www.google.com" activeClassName="active" ><li className='p-4 border-b border-gray-700 hover:border-white hover:transition-[0.5s] hover:ease-in-out'>Host</li></NavLink>
        <NavLink to="/info" activeClassName="active"><li className='p-4 hover:border-b hover:border-white hover:transition-[0.5s] hover:ease-in-out'>Tutorial</li></NavLink>
        </ul>
        </div>

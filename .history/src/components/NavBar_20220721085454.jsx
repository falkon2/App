  ...
  return (
    <div className='flex justify-between items-center h-20 max-w-[1240px] mx-auto px-4 text-white'>
        ...
        <ul className='hidden  md:flex'>
            <li className='p-4 mx-5 cursor-pointer before:scale-x-0 before:origin-bottom hover:before:scale-x-50 hover:before:origin-top before:content-[" "] before:absolute before:top-0 before:right-0 before:left-0 before:bottom-0 before:inset-0 before:bg-blue-600 before:z-[-1] before:ease-in before:duration-[.3s]'><a href="/">Home</a></li>

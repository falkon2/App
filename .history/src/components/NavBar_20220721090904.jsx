  ...
  return (
    <div className='flex justify-between items-center h-20 max-w-[1240px] mx-auto px-4 text-white'>
        ...
        <ul className='hidden  md:flex'>
            <li className='p-4 mx-5 cursor-pointer after:content-[" "] after:absolute after:w-[45px] after:scale-x-100 after:h-[2px] after:b-[0] after:l-0 after:bg-white after:origin-bottom-right after:transition-[0.5s] after:ease-out hover:after:scale-x-100 hover:after:origin-bottom-left'><a href="/">Home</a></li>

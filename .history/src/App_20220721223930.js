...
function App() {
  ...
  return (
    <div className='text-white' >
      <div style={{display: isToggle ? 'index max-w-[800px] mt-[-96px] w-full h-screen mx-auto text-center flex flex-col justify-center' : 'index max-w-[800px] mt-[-96px] w-full h-screen mx-auto text-center flex flex-col justify-center' }}>

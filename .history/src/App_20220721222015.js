...
function App() {
  ...
  return (
    <div className='text-white' >
      <div style={{display: isToggle ? <p>hello</p> : <App/> }}id='index' className='index max-w-[800px] mt-[-96px] w-full h-screen mx-auto text-center flex flex-col justify-center'>

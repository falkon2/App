  ...
  return (
    <div className='font-poppins' >
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 lg:gap-3 justify-items-center mt-20 '>
        ...
        {/* 3rd card */}
        <div className='py-10 text-white hover:scale-110 transition-[0.5s]'>
          <div className='rounded-lg overflow-hidden shadow-lg max-w-sm shadow-red-600 bg-gradient-to-r from-indigo-500 via-indigo-600 to-pink-600'>
            ...
            <div className='justify-center items-center flex '>
              <button onClick={redTheme} className="bg-white  text-red-600 w-[200px] transition-[0.5s] rounded-lg font-bold my-6 mx-auto py-3 ring-2 ring-white hover:ring-gradient-to-r hover:ring-from-indigo-500 hover:ring-via-indigo-600 hover:ring-to-pink-600  hover:bg-gradient-to-r hover:from-purple-500 hover:via-indigo-600 hover:to-pink-600 hover:shadow-xl hover:shadow-red-800 hover:text-red-100 hover:scale-110" >
                Get It Now!
              </button>
            </div>
          </div>

      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 lg:gap-3 justify-items-center mt-20'>
        ...
        <div className='py-10 text-white'>
          <div className='rounded overflow-hidden shadow-lg max-w-sm shadow-red-600 bg-red-600'>
            ...
            <div className='justify-center items-center flex '>
              <button className="bg-white  text-red-600 w-[200px] transition-[0.5s] rounded-lg font-bold my-6 mx-auto py-3 ring-2 ring-white hover:ring-red-800 hover:bg-red-800 hover:shadow-xl hover:shadow-red-800 hover:text-red-100 hover:scale-110" onClick={forward}>
                Get It Now!
              </button>
            </div>
          </div>

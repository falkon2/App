...
body{
	...
	background-image:linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)), url('https://images.unsplash.com/photo-1483401757487-2ced3fa77952?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1173&q=80');
    ...
    <div >
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 lg:gap-3 justify-items-center mt-20 '>
        ...
        <div className='py-10 text-white hover:scale-110 transition-[0.5s] '>
          <div className='rounded-3xl overflow-hidden shadow-lg shadow-white bg-black  max-w-sm '>
            ...
            <div className='justify-center items-center flex '>
              <button className="bg-white  text-black w-[200px] transition-[0.5s] rounded-3xl font-bold my-6 mx-auto py-3 ring-2 ring-white hover:ring-black hover:bg-black  hover:shadow-xl hover:shadow-white hover:text-white hover:scale-110">
                Get It Now!
              </button>
            </div>
          </div>
        ...
        <div className='py-10 text-white'>
          <div className='rounded overflow-hidden shadow-lg max-w-sm shadow-red-600 bg-red-600'>
            ...
            <div className='justify-center items-center flex '>
              <button onClick={blackTheme} className="bg-white  text-red-600 w-[200px] transition-[0.5s] rounded-lg font-bold my-6 mx-auto py-3 ring-2 ring-white hover:ring-red-800 hover:bg-red-800 hover:shadow-xl hover:shadow-red-800 hover:text-red-100 hover:scale-110" >
                Get It Now!
              </button>
            </div>
          </div>

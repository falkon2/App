      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 lg:gap-3 justify-items-center mt-20 '>
        ...
        <div className='py-10 text-black hover:scale-110 transition-[0.5s]'>
          <div className='rounded-lg overflow-hidden  shadow-lg shadow-white bg-white max-w-sm'>
            ...
            <div className='justify-center items-center flex '>
              <button onClick={blueTheme} className="bg-white  text-black w-[200px] transition-[0.5s] rounded-lg font-bold my-6 mx-auto py-3 ring-2 ring-black hover:ring-black hover:bg-black hover:shadow-xl hover:shadow-blue-700 hover:text-blue-200 hover:scale-110">
                Get It Now!
              </button>
            </div>
          </div>

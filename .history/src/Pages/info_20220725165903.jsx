      ...
      <div className='grid grid-cols-3 lg:gap-3 justify-items-center'>
        ...
        <div className='py-10 text-white'>
          <div className='rounded overflow-hidden shadow-lg shadow-white bg-black  max-w-sm'>
            ...
            <button className="bg-white justify-center text-black w-[200px] transition-[0.5s] rounded-lg font-bold my-6 mx-auto py-3 ring-2 ring-white hover:ring-indigo-600 hover:bg-indigo-600  hover:shadow-xl hover:shadow-indigo-700 hover:text-white hover:scale-110">
              Get It Now!
            </button>
          </div>
        </div>

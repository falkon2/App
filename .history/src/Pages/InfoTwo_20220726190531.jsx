    ...
    <div className='font-poppins' >
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 lg:gap-3 justify-items-center mt-20 '>
        ...
        <div className='py-10 text-white   hover:scale-110 transition-[0.5s] '>
          <div className=' overflow-hidden rounded-lg shadow-lg shadow-white bg-green-500  max-w-sm '>
            ...
            <div className='justify-center items-center flex '>
              <button onClick={blackTheme} className="bg-white  text-black w-[200px] transition-[0.5s] rounded-lg font-bold my-6 mx-auto py-3 ring-2 ring-white hover:ring-green-700 hover:bg-green-700  hover:shadow-xl hover:shadow-green-700 hover:text-white hover:scale-110">
                Get It Now!
              </button>
            </div>
          </div>

  ...
  return (
    ...
    <div className="text-white">
        ...
        >
          ...
          <p> This website builder was made using <a className="underline text-indigo-600">React</a>, <a className="underline text-indigo-600">Tauri</a> and <a className="underline text-indigo-600">Tailwind Css</a>.</p>

        ...
        <div className='py-10 text-white'>
          <div className='rounded overflow-hidden shadow-lg shadow-white bg-black  max-w-sm '>
            ...
            <div className='justify-center items-center flex '>
              <button className="bg-white  text-black w-[200px] transition-[0.5s] rounded-lg font-bold my-6 mx-auto py-3 ring-2 ring-white hover:ring-gray-900 hover:bg-black  hover:shadow-xl hover:shadow-gray-900 hover:text-white hover:scale-110">
                Get It Now!
              </button>
            </div>
          </div>

  ...
  return (
    <div className='font-poppins' >
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 lg:gap-3 justify-items-center mt-20 '>
        ...
        <button className="bg-white text-black w-[200px] text-center flex flex-col justify-center transition-[0.5s] rounded-lg font-bold my-6 mx-auto py-3 ring-2 ring-white hover:ring-indigo-600 hover:bg-indigo-600  hover:shadow-xl hover:shadow-indigo-700 hover:text-white hover:scale-110">
            Create
          </button>
      </div>
    </div>

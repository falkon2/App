      ...
      <div className='grid grid-cols-3 lg:gap-3 justify-items-center'>
        ...
        <div className='py-10 text-blue-500'>
          <div className='rounded overflow-hidden shadow-lg max-w-sm'>
            ...
            <div className='justify-center items-center flex '>
              <button className="bg-white  text-blue-700 w-[200px] transition-[0.5s] rounded-lg font-bold my-6 mx-auto py-3 ring-2 ring-white hover:ring-white hover:bg-black  hover:shadow-xl hover:shadow-white hover:text-white hover:scale-110">
                Get It Now!
              </button>
            </div>
          </div>

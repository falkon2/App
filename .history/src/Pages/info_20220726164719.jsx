...
p{
  ...
  return (
    <div >
      ...
      {/* my Cards */}
      <div className='grid grid-cols-1 lg:grid-cols-3 lg:gap-3 justify-items-center mt-20 rounded-3xl'>
        {/* 1st card */}
        <div className='py-10 text-white hover:scale-110 transition-[0.5s] '>
          <div className=' overflow-hidden shadow-lg shadow-white bg-black  max-w-sm '>

...
export const Info = () => {
  return (
    <div >
      <h1 className='mt-10 mb-2 text-center capitalize text-transparent text-4xl bg-gradient-to-r from-blue-500 to-red-600 font-extrabold bg-clip-text'>themes</h1>'

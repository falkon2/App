...
function App() {
  ...
  return (
    <div className='text-white' >
      <div style={{display: isToggle ? 'none' : 'index max-w-[800px] mt-[-96px] w-full h-screen mx-auto text-center flex flex-col justify-center' }}id='index' className='index max-w-[800px] mt-[-96px] w-full h-screen mx-auto text-center flex flex-col justify-center'>

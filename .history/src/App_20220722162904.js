          ...
          <div>
            <form className="text-black max-w-[400px] w-full mx-auto bg-white p-8">
              ...
              <div className='flex flex-col mb-4'>
                <label>Name</label>
                <input className='border relative bg-gray-400 p-2' type="text" />
              </div>
              <div className='flex flex-col mb-4'>
                <label>Email</label>
                <input className='border relative bg-gray-400 p-2' type="✉️'text" />
              </div>
              <div className='flex flex-col mb-4'>
                <label >Profession</label>
                <input className='border relative bg-gray-400 p-2' placeholder='🏢' type="text" />
              </div>
              <div className='flex flex-col mb-4'>

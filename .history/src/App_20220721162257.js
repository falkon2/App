  ...
  return (
    <div className='text-white'>
      <div className='max-w-[800px] mt-[-96px] w-full h-screen mx-auto text-center flex flex-col justify-center'>
        ...
        <p className='md:text-3xl sm:text-2xl text-xl font-bold py-4 '>A website builder that is focused on <a className='underline text-gray-400'>design</a> and <a className='underline text-gray-300'>simplicity.</a></p>

            ...
            <div className="rounded-md shadow-sm -space-y-px">
              <div>
                ...
                <input
                  ...
                  autoComplete="Name"
                  required
                  className="appearance-none rounded-lg relative block w-full items-center  justify-center px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900  focus:outline-none focus:bg-gray-400 focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm"
                  placeholder="Name"
                />
              </div>
              <div>

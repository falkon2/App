  ...
  return (
    <div className='text-white'>
      <div className='max-w-[800px] mt-[-96px] w-full h-screen mx-auto text-center flex flex-col justify-center'>
        ...
        <button className='bg-white text-black w-[200px] rounded-lg font-bold my-6 mx-auto py-3 hover:bg-slate-300 hover:transition-[0.3s] hover:shadow-xl hover:shadow-white hover:scale-110 '>Create</button>
      </div>
    </div>
  );
}

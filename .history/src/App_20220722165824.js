    ...
    <div className="text-white">
      {!hide ? (
        ...
        >
          ...
          <button
            className="bg-white text-black w-[200px] transition-[0.5s] rounded-lg font-bold my-6 mx-auto py-3 ring-2 ring-gray-300 hover:text-indigo-600  hover:shadow-xl hover:shadow-indigo-600 hover:scale-110"
